...
public class UserData : MonoBehaviour
{
    ...
    private async void LoadTextures(string[] tokenIds, float loadProgress = 0, int errorLoop = 0)
    {
        ...
        for (int i = errorLoop; i < tokenIds.Length; i++)
        {
            ...
            string newImgUri = "https://cryptoboss.win/game/back/images/" + tokenIds[i] + ".png"; // http://a0664627.xsph.ru/cryptoboss_back/images/906.png // https://cryptoboss.win/game/back/images/
